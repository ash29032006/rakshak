...
- **Behavioral Detection**: Accelerometer/gyroscope analysis for abnormal movement patterns
...
- **Database**: MongoDB
- **AI/ML**: On-device processing (no cloud needed)
...
- Gesture detection with camera
- Behavioral detection with sensors
- Real SMS sending
...
Built as part of VICHAR IDEATHON 2026.
...
3. Test with "Test Alert" before relying on detection
